...
#ifndef PX_COLLISION_BOXCONTROLLER
#define PX_COLLISION_BOXCONTROLLER
...
namespace Cct
{
	...
	public:
		...
		virtual	void						move(const PxVec3& disp, PxU32 activeGroups, PxF32 minDist, 
			PxU32& collisionFlags, PxF32 sharpness, const PxFilterData* filterData, PxSceneQueryFilterCallback* filterCallback);
		...
		// PxBoxController
		virtual	const PxVec3&				getExtents()						const;
		virtual	bool						setExtents(const PxVec3& extents);
		//~ PxBoxController
