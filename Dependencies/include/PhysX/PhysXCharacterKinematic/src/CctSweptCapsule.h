...
#ifndef PX_CHARACTER_SWEPTCAPSULE
#define PX_CHARACTER_SWEPTCAPSULE
...
namespace Cct
{
	...
	public:
		...
		PX_INLINE	void	GetCapsule(const PxExtendedVec3& center, PxExtendedCapsule& capsule, PxU32 axis) const
		{
