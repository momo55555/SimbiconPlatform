...
#ifndef PX_CHARACTER_UTILS_H
#define PX_CHARACTER_UTILS_H
...
PX_FORCE_INLINE	bool	testSlope(const PxVec3& normal, PxU32 upDirection, PxF32 slopeLimit)
{
//	printf("%f\n", normal[upDirection]);
	return normal[upDirection]>=0.0f && normal[upDirection]<slopeLimit;
}
	...
	public:
		...
		PX_INLINE	PxExtendedBox(const PxExtendedVec3& _center, const PxVec3& _extents, const PxMat33Legacy& _rot) : center(_center), extents(_extents), rot(_rot){}
		PX_INLINE	~PxExtendedBox()	{}
