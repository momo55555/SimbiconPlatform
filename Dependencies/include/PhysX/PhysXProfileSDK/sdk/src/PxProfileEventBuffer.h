	...
	public:
		...
		inline void startEvent( PxU16 inId, PxU32 threadId, PxU64 contextId, PxU8 cpuId, PxU8 threadPriority, PxU64 inTimestamp )
		{
			...
			if ( mEventFilter.isEventEnabled( inId ) )
				doAddProfileEvent( inId, StartEvent( threadId, contextId, cpuId, threadPriority, inTimestamp ) );
		}
		...
		inline void stopEvent( PxU16 inId, PxU32 threadId, PxU64 contextId, PxU8 cpuId, PxU8 threadPriority, PxU64 inTimestamp )
		{
			TScopedLockType lock( TBaseType::mBufferMutex );
			if ( mEventFilter.isEventEnabled( inId ) )
				doAddProfileEvent( inId, StopEvent( threadId, contextId, cpuId, threadPriority, inTimestamp ) );
		}
		...
		{
			EventValue theEvent( inValue, contextId, threadId );
		...
		{
			physx::profile::CUDAProfileBuffer theEvent( inTimestamp, batchRuntimeInMilliseconds, cudaData, bufLenInBytes, bufferVersion );
