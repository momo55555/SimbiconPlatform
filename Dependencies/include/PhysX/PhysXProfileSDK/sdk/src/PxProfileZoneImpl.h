...
#include "PxProfileConcreteEventFilter.h"
...
namespace physx { namespace profile {
	...
	public:
		...
		virtual void startEvent( PxU16 inId, PxU64 contextId) { if( mEventsActive ) TZoneEventBufferType::startEvent( inId, contextId ); }
		virtual void stopEvent( PxU16 inId, PxU64 contextId) { if( mEventsActive ) TZoneEventBufferType::stopEvent( inId, contextId ); }

		virtual void startEvent( PxU16 inId, PxU64 contextId, PxU32 threadId) { if( mEventsActive ) TZoneEventBufferType::startEvent( inId, contextId, threadId ); }
		virtual void stopEvent( PxU16 inId, PxU64 contextId, PxU32 threadId ) { if( mEventsActive ) TZoneEventBufferType::stopEvent( inId, contextId, threadId ); }
		 ...
		 */
		virtual void eventValue( PxU16 inId, PxU64 contextId, PxI64 inValue ) { if( mEventsActive ) TZoneEventBufferType::eventValue( inId, contextId, inValue ); }
