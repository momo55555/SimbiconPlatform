...
//	DEFINE_MD_EXTRA_DATA_ITEM(RevoluteJoint, RevoluteJointData,		0)
	DEFINE_MD_EXTRA_DATA_ITEM(RevoluteJoint, RevoluteJointData,		mData)
}
...
void SphericalJoint::getMetaData(PxSerialStream& stream)
{
	...
	DEFINE_MD_EXTRA_DATA_ITEM(SphericalJoint, SphericalJointData, mData)
}
...
void DistanceJoint::getMetaData(PxSerialStream& stream)
{
	...
	DEFINE_MD_EXTRA_DATA_ITEM(DistanceJoint, DistanceJointData, mData)
}
...
void D6Joint::getMetaData(PxSerialStream& stream)
{
	...
	DEFINE_MD_EXTRA_DATA_ITEM(D6Joint, D6JointData, mData)
}
...
void PrismaticJoint::getMetaData(PxSerialStream& stream)
{
	...
	DEFINE_MD_EXTRA_DATA_ITEM(PrismaticJoint, PrismaticJointData, mData)
}
...
void FixedJoint::getMetaData(PxSerialStream& stream)
{
	...
	DEFINE_MD_EXTRA_DATA_ITEM(FixedJoint, FixedJointData, mData)
}
