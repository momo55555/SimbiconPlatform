...
#define DEFINE_EXTENSION_ENUM_RANGE_MAP( enumName ) \
template<> \
struct PxEnumRangeMap<PxExtensionsPropertyInfoName::enumName> \
{ \
	PxU32 Start;  \
	PxU32 Stop; \
	PxEnumRangeMap() : Start( PxExtensionPvdOnlyProperties::enumName##Begin ), Stop( PxExtensionPvdOnlyProperties::enumName##End ) {} \
}; 


DEFINE_EXTENSION_ENUM_RANGE_MAP( PxJoint_Actors )
DEFINE_EXTENSION_ENUM_RANGE_MAP( PxJoint_BreakForce );
DEFINE_EXTENSION_ENUM_RANGE_MAP( PxD6Joint_DriveVelocity );
DEFINE_EXTENSION_ENUM_RANGE_MAP( PxD6Joint_Motion );
DEFINE_EXTENSION_ENUM_RANGE_MAP( PxD6Joint_Drive );
DEFINE_EXTENSION_ENUM_RANGE_MAP( PxD6Joint_LinearLimit );
DEFINE_EXTENSION_ENUM_RANGE_MAP( PxD6Joint_SwingLimit );
DEFINE_EXTENSION_ENUM_RANGE_MAP( PxD6Joint_TwistLimit );
DEFINE_EXTENSION_ENUM_RANGE_MAP( PxPrismaticJoint_Limit );
DEFINE_EXTENSION_ENUM_RANGE_MAP( PxRevoluteJoint_Limit );
DEFINE_EXTENSION_ENUM_RANGE_MAP( PxSphericalJoint_LimitCone );
DEFINE_EXTENSION_ENUM_RANGE_MAP( PxJoint_LocalPose );
