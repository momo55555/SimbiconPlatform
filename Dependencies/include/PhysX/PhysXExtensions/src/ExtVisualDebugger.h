...
namespace Ext
{
	...
	public:
		...
		static void setActors( PVD::PvdDataStream& PvdDataStream, const PxJoint* inJoint, const PxConstraint* c, const PxActor* newActor0, const PxActor* newActor1 );

#define DEFINE_JOINT_PVD_OPERATIONS( jointtype )														\
		static void updatePvdProperties(PVD::PvdDataStream& pvdConnection, const jointtype* joint);		\
		static void simUpdate(PVD::PvdDataStream& pvdConnection, const jointtype* joint);				\
		static void createPvdInstance(PVD::PvdDataStream& pvdConnection, const PxConstraint* c, const jointtype* joint);
		...
		static void sendClassDescriptions(PVD::PvdDataStream& pvdConnection);
	};
}
