...
/**
 * Allocate a CUDA Context manager, complete with heaps and task dispatcher.
 ...
 */
CudaContextManager* createCudaContextManager(const CudaContextManagerDesc& desc, physx::PxProfileZoneManager* mgr);
