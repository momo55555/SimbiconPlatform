...
inline void SetNumSweptContactPairs( PxSimulationStatistics* inStats, PxGeometryType::Enum idx1, PxGeometryType::Enum idx2, PxU32 val ) { inStats->numSweptContactPairs[idx1][idx2] = val; }
inline PxU32 GetNumSweptContactPairs( const PxSimulationStatistics* inStats, PxGeometryType::Enum idx1, PxGeometryType::Enum idx2 ) { return inStats->numSweptContactPairs[idx1][idx2]; }
PX_PHYSX_CORE_API NumSweptContactPairsProperty::NumSweptContactPairsProperty()
								: PxDualIndexedPropertyInfo<PxPropertyInfoName::PxSimulationStatistics_NumSweptContactPairs
															, PxSimulationStatistics
															, PxGeometryType::Enum
															, PxGeometryType::Enum
															, PxU32> ( "NumSweptContactPairs", SetNumSweptContactPairs, GetNumSweptContactPairs )
{
}
...
inline PxU32 GetNbPxClothFabric_Restlengths( const PxClothFabric* fabric ) { return fabric->getNbParticleIndices() - (fabric->getNbFibers() - 1); }
inline PxU32 GetPxClothFabric_Restlengths( const PxClothFabric* fabric, PxReal* outBuffer, PxU32 outBufLen ){ return fabric->getRestlengths( outBuffer, outBufLen ); }

PX_PHYSX_CORE_API RestlengthsProperty::RestlengthsProperty()
	: PxReadOnlyCollectionPropertyInfo<PxPropertyInfoName::PxClothFabric_Restlengths, PxClothFabric, PxReal>( "Restlengths", GetPxClothFabric_Restlengths, GetNbPxClothFabric_Restlengths )
{
}
