...
namespace Gu
{
	...
	public:
		...
		@see Triangle PxTriangleFlags PxTriangleID findOverlapTriangleMesh()
		*/
		static void getTriangle(const PxTriangleMeshGeometry& triGeom, const PxTransform& transform, PxTriangleID triangleIndex, Gu::Triangle& triangle, Gu::Triangle* edgeTri, PxU32* flags, PxU32* vertexIndices=NULL);
		...
		@see Triangle PxTriangleFlags PxTriangleID findOverlapHeightField()
		*/
		static void getTriangle(const PxHeightFieldGeometry& hfGeom, const PxTransform& transform, PxTriangleID triangleIndex, Gu::Triangle& triangle, Gu::Triangle* edgeTri, PxU32* flags, PxU32* vertexIndices=NULL);
		...
		*/
		static PxU32 findOverlapTriangleMesh(const PxGeometry& geom0, const PxTransform& pose0,
		...
		*/
		static PxU32 findOverlapHeightField(const PxGeometry& geom0,
