...
namespace Gu
{
	...
	PxReal distancePointSegmentSquared(const PxVec3& p0, const PxVec3& p1, const PxVec3& point, PxReal* param=NULL);

	Ps::aos::FloatV distancePointSegmentSquared(const Ps::aos::Vec3VArg p0, const Ps::aos::Vec3VArg p1, const Ps::aos::Vec3VArg point, Ps::aos::FloatV& param);
	...
	Ps::aos::Vec4V distancePointSegmentSquared(const Ps::aos::Vec3VArg a, const Ps::aos::Vec3VArg b, 
												const Ps::aos::Vec3VArg p0, const Ps::aos::Vec3VArg p1,
												const Ps::aos::Vec3VArg p2, const Ps::aos::Vec3VArg p3,
												Ps::aos::Vec4V& param);
