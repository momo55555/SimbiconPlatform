...
namespace Gu
{
	...
	PxReal distanceSegmentBoxSquared(	const PxVec3& segmentPoint0, const PxVec3& segmentPoint1,
										const PxVec3& boxOrigin, const PxVec3& boxExtent, const PxMat33& boxBase,
										PxReal* segmentParam = NULL,
										PxVec3* boxParam = NULL);

	Ps::aos::FloatV distanceSegmentBoxSquared(	const Ps::aos::Vec3VArg segmentPoint0, const Ps::aos::Vec3VArg segmentPoint1,
