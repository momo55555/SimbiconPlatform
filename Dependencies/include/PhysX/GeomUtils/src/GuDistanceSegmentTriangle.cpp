													...
													Ps::aos::Vec3V& closest0, Ps::aos::Vec3V& closest1)
{
	...
	Vec4V t40, t41;
	//const Vec4V sqDist44 = distanceSegmentSegmentSquared4(p,q,a,b, p,q, b,c, p,q, a,c, p,q, a,b, t40, t41);
	...
	const Vec3V closestP00 = V3MulAdd(pq, t00, p);
	const Vec3V closestP01 = V3MulAdd(ab, t01, a);

	const Vec3V closestP10 = V3MulAdd(pq, t10, p);
	const Vec3V closestP11 = V3MulAdd(bc, t11, b);

	const Vec3V closestP20 = V3MulAdd(pq, t20, p);
	const Vec3V closestP21 = V3MulAdd(ac, t21, a);
