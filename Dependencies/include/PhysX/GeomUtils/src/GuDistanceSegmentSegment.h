...
namespace Gu
{
	...
	PxReal distanceSegmentSegmentSquaredOLD(	const PxVec3& seg0_origin, const PxVec3& seg0_extent,
	...
	PxReal distanceSegmentSegmentSquared2(	const Gu::Segment& segment0,
												const Gu::Segment& segment1,
												PxReal* param0=NULL, 
												PxReal* param1=NULL);


	Ps::aos::FloatV distanceSegmentSegmentSquared(const Ps::aos::Vec3VArg p1, const Ps::aos::Vec3VArg d1, const Ps::aos::Vec3VArg p2, const Ps::aos::Vec3VArg d2,
										 					Ps::aos::FloatV& param0, 
										 					Ps::aos::FloatV& param1);
	void distanceSegmentSegmentSquaredNoClamp(const Ps::aos::Vec3VArg p1, 
	...
	*/
	Ps::aos::Vec4V distanceSegmentSegmentSquared4(  const Ps::aos::Vec3VArg p01, const Ps::aos::Vec3VArg q01, 
	...
	*/
	...
	void distanceSegmentSegmentSquared4(		const Ps::aos::Vec3VArg p, const Ps::aos::Vec3VArg d0, 
