...
namespace Gu
{
	...
	class PxBounds3V;
	class PxBoxV;
	bool intersectOBBOBB(const PxVec3& e0, const PxVec3& c0, const PxMat33& r0, const PxVec3& e1, const PxVec3& c1, const PxMat33& r1, bool full_test);

	bool intersectOBBOBB(const Ps::aos::Vec3VArg e0, const Ps::aos::Vec3VArg c0, const Ps::aos::Mat33V& r0, const Ps::aos::Vec3VArg e1, const Ps::aos::Vec3VArg c1, const Ps::aos::Mat33V& r1, bool full_test);
