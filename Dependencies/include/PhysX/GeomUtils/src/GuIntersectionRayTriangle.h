...
namespace Gu
{
	bool intersectLineTriangleCulling(const PxVec3& orig, 
								const PxVec3& dir, 
								const PxVec3& vert0, 
								const PxVec3& vert1, 
								const PxVec3& vert2, 
	...
	bool intersectLineTriangleNoCulling(const PxVec3& orig, 
								const PxVec3& dir, 
								const PxVec3& vert0, 
								const PxVec3& vert1, 
								const PxVec3& vert2, 
	...
	*/
	...
	inline bool intersectRayTriangle(	const Ps::aos::Vec3VArg orig, const Ps::aos::Vec3VArg dir,
	...
	inline Ps::aos::BoolV intersectRayTriangle4(	const Ps::aos::Vec3VArg orig, const Ps::aos::Vec3VArg dir,
