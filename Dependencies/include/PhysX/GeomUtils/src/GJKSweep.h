...
public:
	...
	virtual PxVec3	inverseSupportMapping(const PxVec3& pointOnSurface, int& isFace) const = 0;
};
...
bool convexConvexFullMotionSweep(
		const GJKConvexInterface& convexA, const GJKConvexInterface& convexB,
