...
PX_PROFILE_EVENT(SimTask, solveSimpleGroupB, PX_PROFILE_TASK_PRIORITY)
PX_PROFILE_EVENT(SimTask, resizeArrays, PX_PROFILE_TASK_PRIORITY)
...
PX_PROFILE_EVENT(SimTask, ScSweepBroadPhase, PX_PROFILE_TASK_PRIORITY)
PX_PROFILE_EVENT(SimTask, ScUpdateSweep, PX_PROFILE_TASK_PRIORITY)
PX_PROFILE_EVENT(SimTask, ScSweptIntegration, PX_PROFILE_TASK_PRIORITY)
...
PX_PROFILE_EVENT(SimTask, ScDeformableFinalizationUpdate, PX_PROFILE_TASK_PRIORITY)
PX_PROFILE_EVENT(SimTask, ScDeformableCollisionUpdate, PX_PROFILE_TASK_PRIORITY)
PX_PROFILE_EVENT(SimTask, ScDeformablePreSolverUpdate, PX_PROFILE_TASK_PRIORITY)
PX_PROFILE_EVENT(SimTask, ScDeformableOneWaySolverUpdate, PX_PROFILE_TASK_PRIORITY)
...
PX_PROFILE_EVENT(Sim, DeformableSim_startStep, Coarse)
PX_PROFILE_EVENT(Sim, DeformableSim_shapesUpdateProcessing, Coarse)
PX_PROFILE_EVENT(Sim, DeformableSim_updateBounds, Coarse)
PX_PROFILE_EVENT(Sim, DeformableSim_endStep, Coarse)
PX_PROFILE_EVENT(Sim, DeformableSim_updateReadData, Coarse)
PX_PROFILE_EVENT(Sim, DeformableSim_updatePressure, Coarse)
PX_PROFILE_EVENT(Sim, DeformableSim_updateWind, Coarse)
PX_PROFILE_EVENT(Sim, DeformableSim_updateSleeping, Coarse)
...
PX_PROFILE_EVENT(SceneQuery, overlapAny, PX_PROFILE_SCENEQUERY_PRIORITY)
...
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_SU, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_PRE_SOLVE, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_ONE_WAY_SOLVER, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_SOLVE_CLOTH, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_SOLVE_SOFTBODY, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_COMPUTE_CONTACT, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_APPLY_CONTACT, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_SOLVE_SURFACE, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_COMPUTE_ATTACHMENT, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_APPLY_ATTACHMENT, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_COLL_SURFACE_PRUNING, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_FINALIZATION, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_HIERARCHY_CREATION, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_HIERARCHY_SOLVE, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_SOLVE_LEVEL, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_PROLONG_LEVEL, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_CLOTHING_DATA_UPDATE, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_CLOTHING_POS_CONSTRAIN, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_TEAR, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_COLL_PARTICLES, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_COLL_SURFACE, Detail)
PX_PROFILE_EVENT(Legacy, PXS_PROFILE_ZONE_DF_SELF_COLL, Detail)
