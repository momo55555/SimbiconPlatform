...
#include "PxProfileDeclareEventInfo.h"
...
namespace Cm
{
	...
	{
		physx::PxProfileNames getProfileNames() const;
	};
...
#undef PX_PROFILE_END_SUBSYSTEM
	...
	class EventProfiler
	{
		physx::pubfnd::PxU64					mEventContext;
		physx::PxProfileEventSender*			mSDK;
	public:
		EventProfiler( physx::PxProfileEventSender* inSDK = NULL, physx::pubfnd3::PxU64 inEventContext = 0 )
		...
		physx::pubfnd3::PxU64 getEventContext() const { return mEventContext; }
	};
}
...
class CmProfileZone
{
	...
	physx::pubfnd::PxU16 mEventId;
	physx::pubfnd::PxU64 mEventContext;
public:
	template<typename TProfileDataProvider>
	CmProfileZone( TProfileDataProvider& inProvider, physx::pubfnd::PxU16 inEventId )
...
{
public:
	template<typename TProfileDataProvider> CmProfileZone( TProfileDataProvider&, physx::pubfnd::PxU16) {}
};
...
{
	template<typename TProfileDataProvider>
	CmProfileValue( TProfileDataProvider& inProvider, physx::pubfnd::PxU16 inEventId, physx::pubfnd::PxI64 theValue )
	{
		physx::PxProfileEventSender* theEventSender = inProvider.getEventProfiler().getProfileEventSender();
		physx::pubfnd::PxU64 theContext = inProvider.getEventProfiler().getEventContext();
...
{
	template<typename TProfileDataProvider> 
	CmProfileValue( TProfileDataProvider&, physx::pubfnd::PxU16, physx::pubfnd::PxI64 )
	{
	}
};
...
inline physx::pubfnd3::PxU64 getProfileEventContext() { return 0; }
