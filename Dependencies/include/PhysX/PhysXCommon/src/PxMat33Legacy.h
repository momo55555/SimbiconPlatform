...
#ifndef PX_PHYSICS_COMMON_NX_MAT33LEGACY
#define PX_PHYSICS_COMMON_NX_MAT33LEGACY
...
public:
	...
	PX_CUDA_CALLABLE PX_INLINE PxMat33 toPxMat33() const;
	...
	*/
	...
	PX_DEPRECATED PX_INLINE void diagonal(const PxVec3& vec) { setDiagonal(vec); }
	...
	*/
	...
	PX_DEPRECATED PX_INLINE void star(const PxVec3& vec) { setStar(vec); }


	PX_CUDA_CALLABLE PX_FORCE_INLINE void setFromQuat(const PxQuat&);
	PX_DEPRECATED PX_INLINE void fromQuat(const PxQuat& q) { PX_ASSERT(q.isValid()); setFromQuat(q); }

	PX_INLINE PxQuat toQuat() const;
	...
	*/
	...
	PX_DEPRECATED PX_INLINE void multiply(const PxMat33Legacy left, const PxMat33Legacy right) { setMultiply(left, right); }
	...
	*/
	...
	PX_DEPRECATED PX_INLINE void multiplyTransposeLeft(const PxMat33Legacy left, const PxMat33Legacy right) { setMultiplyTransposeLeft(left, right); }
	...
	*/
	...
	PX_DEPRECATED PX_INLINE void rotX(PxReal angle) { setRotX(angle); }
...
PX_INLINE PxMat33Legacy::PxMat33Legacy()
{
}


PX_INLINE PxMat33Legacy::PxMat33Legacy(const PxMat33Legacy& a)
{
	s = a.s;
}

PX_INLINE PxMat33Legacy::PxMat33Legacy(const PxMat33&m)
{
	s._11 = m(0,0);
	s._12 = m(0,1);
	s._13 = m(0,2);
...
PX_FORCE_INLINE PxMat33Legacy::PxMat33Legacy(const PxQuat& q)
{
	PX_ASSERT(q.isValid());
...
PX_INLINE PxMat33Legacy::PxMat33Legacy(const PxVec3& row0, const PxVec3& row1, const PxVec3& row2)
{
...
PX_INLINE PxMat33Legacy& PxMat33Legacy::operator=(const PxMat33Legacy& a)
{
	s = a.s;
	return *this;
}

PX_INLINE PxMat33 PxMat33Legacy::toPxMat33() const
{
	PxMat33 result;
...
PX_INLINE void PxMat33Legacy::setRowMajor(const PxF32* d)
{
...
PX_INLINE void PxMat33Legacy::setRowMajor(const PxF32 d[][3])
{
	//we are also row major, so this is a direct copy
	s._11 = (PxReal)d[0][0];
	s._12 = (PxReal)d[0][1];
...
PX_INLINE void PxMat33Legacy::setColumnMajor(const PxF32* d)
{
...
PX_INLINE void PxMat33Legacy::setColumnMajor(const PxF32 d[][3])
{
	//we are column major, so copy transposed.
	s._11 = (PxReal)d[0][0];
	s._12 = (PxReal)d[1][0];
...
PX_INLINE void PxMat33Legacy::getRowMajor(PxF32* d) const
{
	//we are also row major, so this is a direct copy
	d[0] = (PxF32)s._11;
	d[1] = (PxF32)s._12;
...
PX_INLINE void PxMat33Legacy::getRowMajor(PxF32 d[][3]) const
{
	//we are also row major, so this is a direct copy
	d[0][0] = (PxF32)s._11;
	d[0][1] = (PxF32)s._12;
...
PX_INLINE void PxMat33Legacy::getColumnMajor(PxF32* d) const
{
	//we are column major, so copy transposed.
	d[0] = (PxF32)s._11;
	d[3] = (PxF32)s._12;
...
PX_INLINE void PxMat33Legacy::getColumnMajor(PxF32 d[][3]) const
{
	//we are column major, so copy transposed.
	d[0][0] = (PxF32)s._11;
	d[1][0] = (PxF32)s._12;
...
PX_INLINE void PxMat33Legacy::setRowMajorStride4(const PxF32* d)
{
	//we are also row major, so this is a direct copy
...
PX_INLINE void PxMat33Legacy::setRowMajorStride4(const PxF32 d[][4])
{
	//we are also row major, so this is a direct copy
	s._11 = (PxReal)d[0][0];
	s._12 = (PxReal)d[0][1];
...
PX_INLINE void PxMat33Legacy::setColumnMajorStride4(const PxF32* d)
{
	//we are column major, so copy transposed.
	//however we've got to skip every 4th element.
	s._11 = (PxReal)d[0];
...
PX_INLINE void PxMat33Legacy::setColumnMajorStride4(const PxF32 d[][4])
{
	//we are column major, so copy transposed.
	s._11 = (PxReal)d[0][0];
	s._12 = (PxReal)d[1][0];
...
PX_INLINE void PxMat33Legacy::getRowMajorStride4(PxF32* d) const
{
	//we are also row major, so this is a direct copy
	//however we've got to skip every 4th element.
	d[0] = (PxF32)s._11;
...
PX_INLINE void PxMat33Legacy::getRowMajorStride4(PxF32 d[][4]) const
{
	//we are also row major, so this is a direct copy
	d[0][0] = (PxF32)s._11;
	d[0][1] = (PxF32)s._12;
...
PX_INLINE void PxMat33Legacy::getColumnMajorStride4(PxF32* d) const
{
	//we are column major, so copy transposed.
	//however we've got to skip every 4th element.
	d[0] = (PxF32)s._11;
...
PX_INLINE void PxMat33Legacy::getColumnMajorStride4(PxF32 d[][4]) const
{
	//we are column major, so copy transposed.
	d[0][0] = (PxF32)s._11;
	d[1][0] = (PxF32)s._12;
...
PX_INLINE void PxMat33Legacy::setRowMajor(const PxF64*d)
{
	//we are also row major, so this is a direct copy
	s._11 = (PxReal)d[0];
	s._12 = (PxReal)d[1];
...
PX_INLINE void PxMat33Legacy::setRowMajor(const PxF64 d[][3])
{
	//we are also row major, so this is a direct copy
	s._11 = (PxReal)d[0][0];
	s._12 = (PxReal)d[0][1];
...
PX_INLINE void PxMat33Legacy::setColumnMajor(const PxF64*d)
{
	//we are column major, so copy transposed.
	s._11 = (PxReal)d[0];
	s._12 = (PxReal)d[3];
...
PX_INLINE void PxMat33Legacy::setColumnMajor(const PxF64 d[][3])
{
	//we are column major, so copy transposed.
	s._11 = (PxReal)d[0][0];
	s._12 = (PxReal)d[1][0];
...
PX_INLINE void PxMat33Legacy::getRowMajor(PxF64*d) const
{
	//we are also row major, so this is a direct copy
	d[0] = (PxF64)s._11;
	d[1] = (PxF64)s._12;
...
PX_INLINE void PxMat33Legacy::getRowMajor(PxF64 d[][3]) const
{
	//we are also row major, so this is a direct copy
	d[0][0] = (PxF64)s._11;
	d[0][1] = (PxF64)s._12;
...
PX_INLINE void PxMat33Legacy::getColumnMajor(PxF64*d) const
{
	//we are column major, so copy transposed.
	d[0] = (PxF64)s._11;
	d[3] = (PxF64)s._12;
...
PX_INLINE void PxMat33Legacy::getColumnMajor(PxF64 d[][3]) const
{
	//we are column major, so copy transposed.
	d[0][0] = (PxF64)s._11;
	d[1][0] = (PxF64)s._12;
...
PX_INLINE void PxMat33Legacy::setRowMajorStride4(const PxF64*d)
{
	//we are also row major, so this is a direct copy
	//however we've got to skip every 4th element.
	s._11 = (PxReal)d[0];
...
PX_INLINE void PxMat33Legacy::setRowMajorStride4(const PxF64 d[][4])
{
	//we are also row major, so this is a direct copy
	s._11 = (PxReal)d[0][0];
	s._12 = (PxReal)d[0][1];
...
PX_INLINE void PxMat33Legacy::setColumnMajorStride4(const PxF64*d)
{
	//we are column major, so copy transposed.
	//however we've got to skip every 4th element.
	s._11 = (PxReal)d[0];
...
PX_INLINE void PxMat33Legacy::setColumnMajorStride4(const PxF64 d[][4])
{
	//we are column major, so copy transposed.
	s._11 = (PxReal)d[0][0];
	s._12 = (PxReal)d[1][0];
...
PX_INLINE void PxMat33Legacy::getRowMajorStride4(PxF64*d) const
{
	//we are also row major, so this is a direct copy
	//however we've got to skip every 4th element.
	d[0] = (PxF64)s._11;
...
PX_INLINE void PxMat33Legacy::getRowMajorStride4(PxF64 d[][4]) const
{
	//we are also row major, so this is a direct copy
	d[0][0] = (PxF64)s._11;
	d[0][1] = (PxF64)s._12;
...
PX_INLINE void PxMat33Legacy::getColumnMajorStride4(PxF64*d) const
...
PX_INLINE void PxMat33Legacy::getColumnMajorStride4(PxF64 d[][4]) const
{
	//we are column major, so copy transposed.
	d[0][0] = (PxF64)s._11;
	d[1][0] = (PxF64)s._12;
...
PX_INLINE void PxMat33Legacy::setRow(int row, const PxVec3&  v)
{
...
PX_INLINE void PxMat33Legacy::setColumn(int col, const PxVec3& v)
{
#ifndef TRANSPOSED_MAT33
	m[0][col] = v.x;
	m[1][col] = v.y;
...
PX_INLINE void PxMat33Legacy::getRow(int row, PxVec3& v) const
{
#ifndef TRANSPOSED_MAT33
	v.x = m[row][0];
	v.y = m[row][1];
...
PX_INLINE void PxMat33Legacy::getColumn(int col, PxVec3& v) const
{
#ifndef TRANSPOSED_MAT33
	v.x = m[0][col];
	v.y = m[1][col];
...
PX_INLINE PxVec3 PxMat33Legacy::getRow(int row) const
{
#ifndef TRANSPOSED_MAT33
...
PX_INLINE PxVec3 PxMat33Legacy::getColumn(int col) const
{
#ifndef TRANSPOSED_MAT33
...
PX_INLINE PxReal& PxMat33Legacy::operator()(int row, int col)
{
...
PX_INLINE const PxReal& PxMat33Legacy::operator() (int row, int col) const
{
	PX_ASSERT(row>=0 && row<3 && col>=0 && col<3);
#ifndef TRANSPOSED_MAT33
	return m[row][col];
...
PX_INLINE bool PxMat33Legacy::isIdentity() const
{
...
PX_INLINE bool PxMat33Legacy::isZero() const
{
...
PX_INLINE bool PxMat33Legacy::isFinite() const
{
...
PX_INLINE void PxMat33Legacy::setZero()
{
	s._11 = PxReal(0);
	s._12 = PxReal(0);
	s._13 = PxReal(0);
...
PX_INLINE void PxMat33Legacy::setIdentity()
{
	s._11 = PxReal(1);
	s._12 = PxReal(0);
	s._13 = PxReal(0);
...
PX_INLINE void PxMat33Legacy::setNegative()
{
	s._11 = -s._11;
	s._12 = -s._12;
	s._13 = -s._13;
...
PX_INLINE void PxMat33Legacy::setDiagonal(const PxVec3& v)
{
	s._11 = v.x;
	s._12 = PxReal(0);
	s._13 = PxReal(0);
...
PX_INLINE void PxMat33Legacy::setStar(const PxVec3& v)
{
...
PX_FORCE_INLINE void PxMat33Legacy::setFromQuat(const PxQuat& q)
{
	PX_ASSERT(q.isValid());
	...
	const PxReal xs = x + x;	const PxReal ys = y + y;	const PxReal zs = z + z;
	const PxReal wx = w * xs;	const PxReal wy = w * ys;	const PxReal wz = w * zs;
	const PxReal xx = x * xs;	const PxReal xy = x * ys;	const PxReal xz = x * zs;
	const PxReal yy = y * ys;	const PxReal yz = y * zs;	const PxReal zz = z * zs;
...
PX_INLINE PxQuat PxMat33Legacy::toQuat() const
{
	PxQuat q;
...
PX_INLINE void PxMat33Legacy::orthonormalize()	//Gram-Schmidt orthogonalization to correct numerical drift, plus column normalization
{
//TODO: This is buggy!
PxVec3 w,t1,t2,t3;
PxReal norm_sq;
...
PX_INLINE void PxMat33Legacy::setTransposed(const PxMat33Legacy& other)
{
...
PX_INLINE void PxMat33Legacy::multiplyDiagonal(const PxVec3& d, PxMat33Legacy& dst) const
{
	dst.s._11 = s._11 * d.x;
	dst.s._12 = s._12 * d.y;
	dst.s._13 = s._13 * d.z;
...
PX_INLINE void PxMat33Legacy::multiplyDiagonalTranspose(const PxVec3& d, PxMat33Legacy& dst) const
{
	dst.s._11 = s._11 * d.x;
	dst.s._12 = s._21 * d.y;
	dst.s._13 = s._31 * d.z;
...
PX_INLINE void PxMat33Legacy::multiply(const PxVec3& src, PxVec3& dst) const
{
	dst = multiply(src);
}

PX_INLINE PxVec3 PxMat33Legacy::multiply(const PxVec3& src) const
{
	PxVec3 result;
...
PX_INLINE void PxMat33Legacy::multiplyByTranspose(const PxVec3& src, PxVec3& dst) const
{
	dst = multiplyByTranspose(src);
}

PX_INLINE PxVec3 PxMat33Legacy::multiplyByTranspose(const PxVec3& src) const
{
	PxVec3 result;
...
PX_INLINE void PxMat33Legacy::setAdd(const PxMat33Legacy& a, const PxMat33Legacy& b)
{
...
PX_INLINE void PxMat33Legacy::setSubtract(const PxMat33Legacy& a, const PxMat33Legacy& b)
{
	s._11 = a.s._11 - b.s._11;
	s._12 = a.s._12 - b.s._12;
	s._13 = a.s._13 - b.s._13;
...
PX_INLINE void PxMat33Legacy::setMultiply(PxReal d,  const PxMat33Legacy& a)
{
	s._11 = a.s._11 * d;
	s._12 = a.s._12 * d;
	s._13 = a.s._13 * d;
...
PX_INLINE void PxMat33Legacy::setMultiply(const PxMat33Legacy left, const PxMat33Legacy right)
{
...
PX_INLINE void PxMat33Legacy::setMultiplyTransposeLeft(const PxMat33Legacy left, const PxMat33Legacy right)
{
	PxReal a,b,c, d,e,f, g,h,i;
	//note: temps needed so that x.multiply(x,y) works OK.
...
PX_INLINE void PxMat33Legacy::setMultiplyTransposeRight(const PxMat33Legacy left, const PxMat33Legacy right)
{
	PxReal a,b,c, d,e,f, g,h,i;
	//note: temps needed so that x.multiply(x,y) works OK.
...
PX_INLINE void PxMat33Legacy::setMultiplyTransposeRight(const PxVec3& left, const PxVec3& right)
{
...
PX_INLINE void PxMat33Legacy::setRotX(PxReal angle)
{
...
PX_INLINE void PxMat33Legacy::setRotY(PxReal angle)
{
	PxReal Cos = cosf(angle);
	PxReal Sin = sinf(angle);
	setIdentity();
...
PX_INLINE void PxMat33Legacy::setRotZ(PxReal angle)
{
	PxReal Cos = cosf(angle);
	PxReal Sin = sinf(angle);
	setIdentity();
...
PX_INLINE PxVec3  PxMat33Legacy::operator%(const PxVec3& src) const
{
	PxVec3 dest;
...
PX_INLINE const PxMat33Legacy &PxMat33Legacy::operator +=(const PxMat33Legacy& d)
{
	s._11 += d.s._11;
	s._12 += d.s._12;
	s._13 += d.s._13;
...
PX_INLINE const PxMat33Legacy &PxMat33Legacy::operator *=(PxReal f)
{
	s._11 *= f;
	s._12 *= f;
	s._13 *= f;
...
PX_INLINE const PxMat33Legacy &PxMat33Legacy::operator /=(PxReal x)
{
	PxReal f = PxReal(1) / x;
	s._11 *= f;
	s._12 *= f;
...
PX_INLINE PxReal PxMat33Legacy::determinant() const
{
...
PX_INLINE PxMat33Legacy&	PxMat33Legacy::operator*= (const PxMat33Legacy& mat)
{
...
PX_INLINE PxMat33Legacy	PxMat33Legacy::operator-  (const PxMat33Legacy& mat)	const
{
	PxMat33Legacy temp;
...
PX_INLINE PxMat33Legacy	PxMat33Legacy::operator*  (float s)			const
{
	PxMat33Legacy temp;
