...
//Normalize 
PX_FORCE_INLINE QuatV QuatNormalize(const QuatV q)	// convert this PxQuat to a unit quaternion
{
	return V4Normalize(q);
}

PX_FORCE_INLINE FloatV QuatLength(const QuatV q)	// convert this PxQuat to a unit quaternion
{
	return V4Length(q);
}

PX_FORCE_INLINE FloatV QuatLengthSq(const QuatV q)	// convert this PxQuat to a unit quaternion
{
	return V4LengthSq(q);
}
...
PX_FORCE_INLINE QuatV QuatNeg(const QuatV a)
{
	return V4Neg(a);
}
