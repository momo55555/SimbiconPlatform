...
#ifndef PX_PHYSICS_NXCAPSULECONTROLLER
#define PX_PHYSICS_NXCAPSULECONTROLLER
...
public:
	...
	*/
	...
	<b>Default:</b> PxCapsuleClimbingMode::eCONSTRAINED
...
{
	radius = height = 0.0f;
	climbingMode = PxCapsuleClimbingMode::eCONSTRAINED;
}
