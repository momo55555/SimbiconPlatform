	...
	*/
	enum VolumeType
	{
		...
		*/
		...
		/**
		\brief A volume belonging to a deformable
		@see PxDeformable
		*/
		eDEFORMABLE,
	...
	*/
	enum RbPairStatsType
	{
		...
		*/
		...
		/**
		\brief Shape pairs processed as swept contact generation pairs for the current simulation step.

		@see PxPairFlag::eSWEPT_CONTACT_GENERATION
		*/
		eSWEPT_CONTACT_PAIRS,

		/**
		\brief Shape pairs processed as swept integration pairs for the current simulation step.

		@see PxPairFlag::eSWEPT_INTEGRATION_FULL PxPairFlag::eSWEPT_INTEGRATION_LINEAR
		*/
	...
	*/
	PxU32 getRbPairStats(RbPairStatsType pairType, PxGeometryType::Enum g0, PxGeometryType::Enum g1) const
	{
		...
		switch(pairType)
		{
			...
			case eSWEPT_CONTACT_PAIRS:
				return numSweptContactPairs[g0][g1];
