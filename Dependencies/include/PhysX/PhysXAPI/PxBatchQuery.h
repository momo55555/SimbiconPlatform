...
class PxBatchQuery
	...
	*/
	...
	\param[in] rayOrigin	The origin of the ray to cast in the global frame.
	\param[in] rayDir		The normalized direction of the ray to cast in the global frame.
	...
	*/
	virtual void raycastAny( const PxVec3& rayOrigin, 
							 const PxVec3& rayDir, 
	...
	*/
	virtual void raycastSingle( const PxVec3& rayOrigin, 
								const PxVec3& rayDir, 
								const PxSceneQueryFilterData& filterData = PxSceneQueryFilterData(), 
								PxReal maxDist=PX_MAX_F32, 
	...
	*/
	virtual void raycastMultiple( const PxVec3& rayOrigin, 
								  const PxVec3& rayDir, 
								  const PxSceneQueryFilterData& filterData = PxSceneQueryFilterData(), 
								  PxReal maxDist=PX_MAX_F32, 
								  PxSceneQueryFlags outputFlags = PxSceneQueryFlag::eIMPACT|PxSceneQueryFlag::eNORMAL|PxSceneQueryFlag::eDISTANCE|PxSceneQueryFlag::eUV,
	...
	*/
	...
	\note Supported geometries are: PxBoxGeometry, PxSphereGeometry, PxCapsuleGeometry.
	\note If a shape from the scene is already overlapping with the query shape in its starting position, behavior is controlled by the PxSceneQueryFlag::eINITIAL_OVERLAP flag.
