...
struct PxVisualizationParameter
{
	...
	/* Deformable visualizations */
	
		/**
		\brief Deformable mesh visualization.
		*/
		eDEFORMABLE_MESH,

		/**
		\brief Deformable attachments visualization.
		*/
		eDEFORMABLE_ATTACHMENTS,

		/**
		\brief Deformable collisions visualization.
		*/
		eDEFORMABLE_COLLISIONS,

		/**
		\brief Deformable self-collisions visualization.
		*/
		eDEFORMABLE_SELFCOLLISIONS,
		
		/**
		\brief Deformable sleeping visualization.
		*/
		eDEFORMABLE_SLEEP,

		/**
		\brief Deformable tearing visualization.
		*/
		eDEFORMABLE_TEARING,

		/**
		\brief Deformable valid bounds visualization.
		*/
		eDEFORMABLE_VALIDBOUNDS,

		/**
		\brief Deformable shapes visualization.
		*/
		eDEFORMABLE_SHAPES,
