...
// PX_SERIALIZATION
	...
	public:
								PX_DECLARE_SERIAL_RTTI(PxRigidActor, PxActor)
//~PX_SERIALIZATION
	protected:
...
*/
	...
	*/
	...
	body with the PxRigidDynamicFlag::eKINEMATIC flag, then use the moveKinematic() commands to define its path.
...
*/
	...
	*/
	...
	@see PxActor
	*/
	virtual		PxRigidActor*				isRigidActor()					{ return this; }
	virtual		const PxRigidActor*			isRigidActor()			const	{ return this; }
