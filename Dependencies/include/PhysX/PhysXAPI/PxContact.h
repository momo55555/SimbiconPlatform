...
#ifdef PX_VC
#pragma warning(push)
#pragma warning(disable: 4324)	//disable warning "structure was padded due to __declspec(align())"
#endif
...
struct PxContactPoint
{
	...
	*/
	...
	/**
	\brief The surface feature index of shape 0 at the contact point.  This is used to identify the surface material.
	*/
	PxU32   featureIndex0;

	/**
	\brief The surface feature index of shape 1 at the contact point.  This is used to identify the surface material.
	*/
	PxU32   featureIndex1;
};
