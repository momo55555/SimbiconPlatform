...
public:
	...
	\param[in,out] sortedParticleIndices Pointer to user allocated array of size numParticles where the sorted particle indices will be written to.
	\param[in,out] particleBounds Pointer to user allocated array of size maxBounds where the ParticleBounds will be written to.
	...
	*/
	...
	public:
		...
		\param[in,out] indexBuffer Strided data to which allocated indices are written.
