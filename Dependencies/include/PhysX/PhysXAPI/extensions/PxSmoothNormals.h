...
*/
PX_C_EXPORT bool PX_CALL_CONV PxBuildSmoothNormals(physx::pubfnd3::PxU32 nbTris, physx::pubfnd3::PxU32 nbVerts, const physx::pubfnd3::PxVec3* verts,
												   const physx::pubfnd3::PxU32* dFaces, const physx::pubfnd3::PxU16* wFaces, physx::pubfnd3::PxVec3* normals, bool flip);
