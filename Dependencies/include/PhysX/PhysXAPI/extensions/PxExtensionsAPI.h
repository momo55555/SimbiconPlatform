...
#include "extensions/PxDeformableExt.h"
...
/** \brief Dumps the SDK's meta-data to a file.
...
PX_C_EXPORT bool PX_CALL_CONV PxDumpMetaData(const char* filename, const physx::PxPhysics& sdk);
...
then be serialized. Collected objects include materials, convex meshes, triangle meshes, heightfields
...
then be serialized. Collected objects include actors, attachments, constraints, articulations
and aggregates.
