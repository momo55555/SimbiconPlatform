...
/** Top level public include file for PhysX SDK */
...
// Exposing the ParticleSystem API.
...
#define PX_SLEEP_INTERVAL (20.0f*0.02f)		// Corresponds to 20 frames for the standard time step.
//#define PX_SLEEP_INTERVAL (999999999.0f)	// PT: used for profiling. DO NOT REMOVE.
...
class PxParticleSystemDesc;
class PxParticleFluid;
class PxParticleFluidDesc;
