...
@see PxCloth.lockClothReadData()
*/
class PxClothReadData : public PxLockedData
{
public:
	/**
	...
	*/
	...
	Can be used together with #particles and #PxCloth.getPreviousTimeStep() to compute the particle velocities
	*/
