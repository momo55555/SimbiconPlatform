...
class PxParticleFluidReadData : public PxParticleReadData
	...
	<ol>
	<li>
	Particles which have no neighbors (no particles closer than PxParticleFluidDesc.restParticleDistance * 2) 
	will have a density of zero.
	<li>
	Particles which are at rest density (distances corresponding to PxParticleFluidDesc.restParticleDistance in the mean) 
