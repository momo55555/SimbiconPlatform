...
@see PxParticleSystemDesc, PxParticleBaseDesc, PxParticleBase, PxParticleReadData
*/
...
/** @name Particle System Descriptor Operations
*/
//@{
	...
	@see PxParticleSystemDesc
	*/
	virtual		void							saveToDesc(PxParticleSystemDesc& desc)			const	= 0;
