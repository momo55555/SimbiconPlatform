...
public:
	...
	PX_FORCE_INLINE		PxU32 getFeatureIndex0(PxU32 i)					{ return mContacts[i].featureIndex0; }
	PX_FORCE_INLINE		PxU32 getFeatureIndex1(PxU32 i)					{ return mContacts[i].featureIndex1; }
